 ...
 * 
 */
export const ImageElementComponent : CmsComponent<ImageElementDataFragment, ImageElementLayoutProps> = ({ data, layoutProps, children }) => {
...
ImageElementComponent.displayName = "Image (Component/ImageElement)"
