 ...
 */
export const ArticleListElementComponent : CmsComponent<ArticleListElementDataFragment> = ({ data, children }) => {
...
ArticleListElementComponent.displayName = "Article List (Component/ArticleListElement)"
