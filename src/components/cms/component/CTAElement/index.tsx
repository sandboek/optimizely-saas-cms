 ...
 */
export const CTAElementComponent : CmsComponent<CTAElementDataFragment, CTAElementLayoutProps> = ({ data, layoutProps, children }) => {
...
CTAElementComponent.displayName = "Call To Action (Component/CTAElement)"
CTAElementComponent.getDataFragment = () => ['CTAElementData', CTAElementDataFragmentDoc]
