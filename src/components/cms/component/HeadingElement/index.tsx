 ...
 * 
 */
export const HeadingElementComponent : CmsComponent<HeadingElementDataFragment, HeadingElementLayoutProps> = ({ data, layoutProps, children }) => {
...
HeadingElementComponent.displayName = "Heading (Component/HeadingElement)"
