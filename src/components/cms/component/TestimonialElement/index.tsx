 ...
 */
export const TestimonialElementComponent : CmsComponent<TestimonialElementDataFragment> = ({ data, children }) => {
...
TestimonialElementComponent.displayName = "Testimonial (Component/TestimonialElement)"
